  ...
  return (
    <div className="min-h-screen w-full bg-surface-secondary font-sans text-slate-900 pb-10">
      ...
      <main className="max-w-4xl mx-auto px-6 mt-6 space-y-8 animate-fadeUp">
        ...
        {/* Status Alert */}
        {statusMessage && (
          <div className={`mb-6 p-4 rounded-2xl flex items-center gap-3 shadow-xl border animate-in slide-in-from-top-4 bg-white ${statusMessage.type === 'success' ? 'text-secondary-500 border-secondary-500/20' : 'text-red-500 border-red-100'
            }`}>
            ...
            <div className="flex justify-between items-center bg-sidebar-bg/40 p-5 rounded-[2.5rem] border border-sidebar-bg">
              ...
              {!isEditing ? (
                ...
                <div className="flex gap-4">
                  ...
                  <Button onClick={handleSaveData} disabled={isSaving} className="bg-primary-500  px-8 rounded-2xl shadow-lg font-bold text-xs py-3">
