...
// Card component with TypeScript typing
    ...
    <div className="lp min-h-screen bg-white">
      ...
      <header className="lp-nav bg-white/70 backdrop-blur-md border-b border-gray-200/50 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center py-4">
          <div className="lp-brand flex items-center gap-2">
          <div className="w-8 h-8 bg-cyan-400 rounded-full flex items-center justify-center">
            <span className="text-xs font-bold text-white">✓</span>
          </div>
            <span className="lp-name text-2xl font-bold text-gray-900">LITTLESPARKS</span>
          </div>
          ...
          <div className="lp-actions flex gap-4 items-center">
            <Link className="lp-link text-gray-700 hover:text-cyan-500 transition-colors font-semibold" to="/login">
              Log In
            </Link>
            <button 
      ...
      <section id="why" className="why relative min-h-[300px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full">
          <div className="max-w-2xl">
            ...
            <button 
              className="btn primary bg-cyan-500 text-white px-8 py-4 rounded-full font-bold hover:bg-cyan-600 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 active:scale-95 transform w-fit"
      ...
      <section id="features" className="band py-20 px-4 sm:px-6 lg:px-8 bg-gray-800">
        <div className="wrap center max-w-7xl mx-auto text-center">
          ...
          <Link 
            className="btn whitebtn bg-white text-gray-800 px-8 py-3 rounded-full font-bold hover:bg-gray-50 transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5 active:scale-95 transform inline-block" 
            to="/features"
          >
            See All
          </Link>
        ...
        <div className="wrap two-col max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div className="dash">
            <div className="dash-top bg-gray-100 p-6 rounded-t-2xl">
              ...
              <div className="dash-stat flex gap-2 mt-4">
                <div className="dash-val text-4xl font-bold text-gray-900">75%</div>
                <div className="dash-sub text-sm text-gray-600">Attendance Rate</div>
              </div>
            </div>

            <img
              className="dash-img w-full h-64 object-cover"
              src="https://images.unsplash.com/photo-1759752394755-1241472b589d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1200"
              alt="Dashboard"
            />

            <div className="dots flex gap-3 p-6 bg-gray-100 justify-center rounded-b-2xl">
              <span className="d green w-4 h-4 rounded-full bg-green-400" />
              <span className="d yellow w-4 h-4 rounded-full bg-yellow-400" />
              <span className="d pink w-4 h-4 rounded-full bg-pink-400" />
            </div>
          </div>

          <div>
            <h2 className="h2 text-4xl font-bold text-gray-900 mb-6">Safety & Compliance - Effortlessly Archived</h2>
            <p className="p text-lg text-gray-700 mb-4">
              Managing all of your reports in one place. Save countless hours on paperwork
              and ensure compliance with ease.
            </p>
            <p className="p small text-gray-600 mb-8">
              Our system keeps everything organized, secure, and accessible whenever you need it.
            </p>

            <button 
              className="btn primary bg-cyan-500 text-white px-8 py-3 rounded-full font-bold hover:bg-cyan-600 transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5 active:scale-95 transform"
      ...
      {/* ===== 5) DISCOVER ===== */}
      <section id="discover" className="discover py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-cyan-300 via-blue-300 to-purple-300">
        <div className="wrap discover-box max-w-7xl mx-auto text-center">
          <span className="discover-badge text-sm text-white opacity-90 block mb-6">
            EDUCATORS CHANGE LIVES, WE'RE JUST CHEERLEADERS
          </span>

          <h2 className="discover-title text-5xl font-bold text-white mb-6">
            Discover <span className="hl text-purple-900">LittleSparks</span>!
          </h2>

          <p className="discover-text text-xl text-white mb-10 max-w-2xl mx-auto opacity-90">
          ...
          <button 
            className="btn whitebtn bg-white text-purple-600 px-10 py-5 rounded-full text-xl font-bold hover:bg-gray-50 transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-1.5 active:scale-95 transform"
            onClick={() => navigate("/get-started")}
          >
            Try It Out
          </button>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-8">
            <div>
              ...
              <a href="#safety" className="text-gray-400 hover:text-white transition-colors block">Help Centre</a>
            </div>
            <div>
              <h4 className="font-semibold text-white mb-4">Features</h4>
              <a href="#features" className="text-gray-400 hover:text-white transition-colors block mb-2">Attendance</a>
              <a href="#features" className="text-gray-400 hover:text-white transition-colors block mb-2">Daily Logs</a>
              <a href="#features" className="text-gray-400 hover:text-white transition-colors block">Reports</a>
            </div>
            <div>
              <h4 className="font-semibold text-white mb-4">Company</h4>
              <a href="#why" className="text-gray-400 hover:text-white transition-colors block mb-2">About</a>
              <a href="#discover" className="text-gray-400 hover:text-white transition-colors block">Contact</a>
            </div>
            <div>
              <h4 className="font-semibold text-white mb-4">Legal</h4>
              <a href="#discover" className="text-gray-400 hover:text-white transition-colors block mb-2">Privacy</a>
              <a href="#discover" className="text-gray-400 hover:text-white transition-colors block">Terms</a>
            </div>
          </div>
