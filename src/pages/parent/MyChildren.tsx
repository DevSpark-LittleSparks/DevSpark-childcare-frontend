        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {childrenList.map((child) => (
            ...
            <div 
              ...
              className="group bg-white dark:bg-[#0f172a] rounded-[3rem] p-8 shadow-sm border border-slate-100 dark:border-slate-800/60 dark:border-slate-800/60 hover:shadow-2xl hover:border-primary-200 transition-all duration-500 cursor-pointer relative overflow-hidden"
            >
              ...
              <div className="flex items-center gap-6 mb-8 relative z-10">
                ...
                <div>
                  <h3 className="text-2xl font-black text-midnight dark:text-white tracking-tight">{child.name}</h3>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8 relative z-10">
                <div className="p-4 bg-slate-50 dark:bg-slate-800/40 rounded-2xl">
                  <p className="text-[8px] font-black text-slate-400 dark:text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-1">Age</p>
                  <p className="text-sm font-black text-midnight dark:text-white">{child.age} Years</p>
                </div>
                <div className="p-4 bg-slate-50 dark:bg-slate-800/40 rounded-2xl">
                  <p className="text-[8px] font-black text-slate-400 dark:text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-1">Status</p>
                  <p className="text-sm font-black text-emerald-500 italic">Enrolled</p>
                </div>
              </div>

              {/* --- UPDATED BUTTON SECTION --- */}
              <div className="pt-6 border-t border-slate-50 dark:border-slate-800/60 relative z-10">
                <Button 
                  onClick={() => navigate(`/parent/child-profile/${child.id}`)}
