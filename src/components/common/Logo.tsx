...
/**
 * LittleSparks Logo Icon (SVG mark only, no text) — reusable anywhere the
 * brand mark needs to appear without the wordmark, e.g. chatbot avatars.
 */
export const LogoIcon = ({ color = '#1F2937', className = 'w-10 h-10' }: LogoIconProps) => (
  <svg
    version="1.0"
...
export const Logo = ({
  ...
  return (
    <div className={`flex items-center gap-0 select-none ${className}`}>
      <LogoIcon color={iconColor} className={iconClassName} />
