...
import { 
  ...
  MdCalendarMonth, MdSchool, MdRestaurant, MdSecurity, MdHistory, 
    ...
    <MdMenuOpen className="text-2xl" />
      ...
      <nav className="flex-1 px-3 py-2 overflow-y-auto scrollbar-hide overflow-x-hidden">
        ...
        <NavGroup title="Management" isCollapsed={isCollapsed}>
          <SidebarLink to="/admin/schedules" icon={<MdCalendarMonth />} label="Schedules" isCollapsed={isCollapsed} />
          <SidebarLink to="/admin/learning" icon={<MdSchool />} label="Learning" isCollapsed={isCollapsed} />
